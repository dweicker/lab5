...
$$\Delta T = 0, \hspace*{0.7cm} (x,y) \in \Omega$$
\begin{equation}
T(0,y) = 300,\hspace*{0.5cm} T(4,y) = 600,\hspace*{0.5cm} 0\leq y \leq 2
\label{eq:cond1}
\end{equation} 
\begin{equation}
\dfrac{\dr T  }{\dr y}(x,0) = 0,\hspace*{0.5cm} \dfrac{\dr T}{\dr y}(x,2) = 0,\hspace*{0.5cm} 0< x < 4
\label{eq:cond2}
\end{equation}
